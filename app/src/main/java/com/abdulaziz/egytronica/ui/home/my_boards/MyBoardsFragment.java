 ...
 * {@link MyBoardsFragment.OnMyBoardsFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link MyBoardsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MyBoardsFragment extends Fragment implements
    ...
    private MyBoardsPresenter mPresenter;

    private Request request;

    private OnMyBoardsFragmentInteractionListener mListener;
     ...
     *
     * @return A new instance of fragment MyBoards.
     */
    public static MyBoardsFragment newInstance() {
        MyBoardsFragment fragment = new MyBoardsFragment();
        return fragment;
    }
    ...
    private void init(){
        ...
        //toolbar menu
        toolbar = (Toolbar) getView().findViewById(R.id.my_boards_toolbar);
        logoutBtn = (Button) toolbar.findViewById(R.id.my_boards_logout_btn);

        logoutBtn.setOnClickListener(this);

        //Refresh layout
        refreshLayout = (SwipeRefreshLayout) getView().findViewById(R.id.my_boards_swipe_to_refresh);
        ...
        recyclerView = (RecyclerView) getView().findViewById(R.id.my_boards_recycler_view);
        ...
        adapter.getPositionClicks()
                .subscribe(new Observer<Board>() {
                    ...
                    public void onCompleted() {
                        Log.i(GlobalEntities.MY_BOARDS_ACTIVITY, "onCompleted: ");
                    }

                    @Override
                    public void onError(Throwable e) {
                        Log.e(GlobalEntities.MY_BOARDS_ACTIVITY, "onError: " + e.getMessage());
                    }

                    @Override
                    public void onNext(Board board) {
                        Log.i(GlobalEntities.MY_BOARDS_ACTIVITY, "onNext: " +board.getName());
        ...
        //presenter
        mPresenter = new MyBoardsPresenter(getContext(), DataManager.getInstance());
    ...
    public void boardsReqSuccess(ArrayList<Board> boards) {
        Log.i(GlobalEntities.MY_BOARDS_ACTIVITY, "boardsReqSuccess: "+boards.size());
    ...
    public void boardsReqError(String e) {
        Log.i(GlobalEntities.MY_BOARDS_ACTIVITY, "boardsReqError: "+e);
    ...
    public void boardsReqComplete() {
        Log.i(GlobalEntities.MY_BOARDS_ACTIVITY, "boardsReqComplete: ");
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnMyBoardsFragmentInteractionListener) {
            mListener = (OnMyBoardsFragmentInteractionListener) context;
        } else {
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.my_boards_logout_btn:
                Log.i(GlobalEntities.MY_BOARDS_ACTIVITY, "click: logout");
                mListener.onMyBoardsFragmentInteraction(GlobalEntities.LOGOUT_TAG, "");
                break;
        }
    }
     ...
     */
    public interface OnMyBoardsFragmentInteractionListener {
        void onMyBoardsFragmentInteraction(String action, String message);
    }
}
